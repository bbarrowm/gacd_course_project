...
Tidydf merges several datasets provided by the UCI Human Activity Recognition Using Smartphones project. The tidydf dataset includes a subject identifier, activities, and mean and standard deviation variables for sensor signals. For more information on the UCI HAR dataset, see [link](http://archive.ics.uci.edu/ml/datasets/Human+Activity+Recognition+Using+Smartphones)
